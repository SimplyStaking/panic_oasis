...
GET_JSON_FUNCTION = 'src.monitors.github.get_json'
DUMMY_RELEASES = [
    {'name': 'Release 1'},
    {'name': 'Release 2'},
    {'name': 'Release 3'}
...
# @unittest.skip("Skipping Test Github Monitor Without Redis")
...
# @unittest.skip("Skipping Test Github Monitor With Redis")
